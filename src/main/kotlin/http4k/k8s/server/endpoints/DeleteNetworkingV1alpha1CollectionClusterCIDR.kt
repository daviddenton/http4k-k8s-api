 ...
 * 		401 Unauthorized
 */
fun DeleteNetworkingV1alpha1CollectionClusterCIDR(): RoutingHttpHandler {
    ...
    return "/apis/networking.k8s.io/v1alpha1/clustercidrs" bind Method.DELETE to { req: Request ->
