 ...
 * 		401 Unauthorized
 */
fun WatchAdmissionregistrationV1alpha1ValidatingAdmissionPolicyList(): RoutingHttpHandler {
	...
	return "/apis/admissionregistration.k8s.io/v1alpha1/watch/validatingadmissionpolicies" bind Method.GET to { req: Request ->
