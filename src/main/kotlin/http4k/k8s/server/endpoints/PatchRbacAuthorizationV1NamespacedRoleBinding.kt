 ...
 * 		401 Unauthorized
 */
fun PatchRbacAuthorizationV1NamespacedRoleBinding(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings/{name}" bind Method.PATCH to { req: Request ->
