 ...
 * 		401 Unauthorized
 */
fun PatchCoreV1NamespacedPersistentVolumeClaimStatus(): RoutingHttpHandler {
    ...
    return "/api/v1/namespaces/{namespace}/persistentvolumeclaims/{name}/status" bind Method.PATCH to { req: Request ->
