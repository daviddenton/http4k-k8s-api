 ...
 * 		401 Unauthorized
 */
fun WatchResourceV1alpha1NamespacedResourceClaimTemplateList(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/watch/namespaces/{namespace}/resourceclaimtemplates" bind Method.GET to { req: Request ->
