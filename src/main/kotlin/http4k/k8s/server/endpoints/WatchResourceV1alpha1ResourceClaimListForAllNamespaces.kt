 ...
 * 		401 Unauthorized
 */
fun WatchResourceV1alpha1ResourceClaimListForAllNamespaces(): RoutingHttpHandler {
    ...
    return "/apis/resource.k8s.io/v1alpha1/watch/resourceclaims" bind Method.GET to { req: Request ->
