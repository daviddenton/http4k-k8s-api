 ...
 * 		401 Unauthorized
 */
fun DeleteCertificatesV1CollectionCertificateSigningRequest(): RoutingHttpHandler {
	...
	return "/apis/certificates.k8s.io/v1/certificatesigningrequests" bind Method.DELETE to { req: Request ->
