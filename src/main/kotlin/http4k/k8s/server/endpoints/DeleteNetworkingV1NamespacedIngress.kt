 ...
 * 		401 Unauthorized
 */
fun DeleteNetworkingV1NamespacedIngress(): RoutingHttpHandler {
	...
	return "/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}" bind Method.DELETE to { req: Request ->
