 ...
 * 		401 Unauthorized
 */
fun WatchResourceV1alpha1ResourceClass(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/watch/resourceclasses/{name}" bind Method.GET to { req: Request ->
