 ...
 * 		401 Unauthorized
 */
fun WatchResourceV1alpha1NamespacedResourceClaim(): RoutingHttpHandler {
    ...
    return "/apis/resource.k8s.io/v1alpha1/watch/namespaces/{namespace}/resourceclaims/{name}" bind Method.GET to { req: Request ->
