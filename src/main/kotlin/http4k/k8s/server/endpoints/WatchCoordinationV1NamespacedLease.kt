 ...
 * 		401 Unauthorized
 */
fun WatchCoordinationV1NamespacedLease(): RoutingHttpHandler {
    ...
    return "/apis/coordination.k8s.io/v1/watch/namespaces/{namespace}/leases/{name}" bind Method.GET to { req: Request ->
