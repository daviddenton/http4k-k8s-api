 ...
 * 		401 Unauthorized
 */
fun ConnectCoreV1GetNodeProxyWithPath(): RoutingHttpHandler {
	...
	return "/api/v1/nodes/{name}/proxy/{path}" bind Method.GET to { req: Request ->
		val name = nameLens(req)
		val path = pathLens(req)
		val pathQuery = pathQueryLens(req)
		Response(Status.OK)
			.with(connectCoreV1GetNodeProxyWithPathResponse200Lens of TODO())
	}
}
