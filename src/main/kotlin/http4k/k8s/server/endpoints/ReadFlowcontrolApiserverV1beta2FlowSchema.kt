 ...
 * 		401 Unauthorized
 */
fun ReadFlowcontrolApiserverV1beta2FlowSchema(): RoutingHttpHandler {
	val iok8sapiflowcontrolv1beta2FlowSchemaLens = Body.auto<FlowSchema>().toLens()
	val nameLens = Path.string().of("name")
	val prettyLens = Query.string().optional("pretty")

	return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}" bind Method.GET to { req: Request ->
