 ...
 * 		401 Unauthorized
 */
fun ReplaceAppsV1NamespacedStatefulSetScale(): RoutingHttpHandler {
	...
	return "/apis/apps/v1/namespaces/{namespace}/statefulsets/{name}/scale" bind Method.PUT to { req: Request ->
