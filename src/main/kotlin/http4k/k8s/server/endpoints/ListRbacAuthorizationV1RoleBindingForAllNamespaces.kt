 ...
 * 		401 Unauthorized
 */
fun ListRbacAuthorizationV1RoleBindingForAllNamespaces(): RoutingHttpHandler {
	...
	return "/apis/rbac.authorization.k8s.io/v1/rolebindings" bind Method.GET to { req: Request ->
