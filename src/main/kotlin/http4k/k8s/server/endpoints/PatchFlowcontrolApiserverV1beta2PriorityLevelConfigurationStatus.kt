 ...
 * 		401 Unauthorized
 */
fun PatchFlowcontrolApiserverV1beta2PriorityLevelConfigurationStatus(): RoutingHttpHandler {
	...
	return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations/{name}/status" bind Method.PATCH to { req: Request ->
