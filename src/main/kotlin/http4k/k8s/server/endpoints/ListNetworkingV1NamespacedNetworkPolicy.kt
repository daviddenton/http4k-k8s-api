 ...
 * 		401 Unauthorized
 */
fun ListNetworkingV1NamespacedNetworkPolicy(): RoutingHttpHandler {
    ...
    return "/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapinetworkingv1NetworkPolicyListLens of TODO())
    }
}
