 ...
 * 		401 Unauthorized
 */
fun DeleteRbacAuthorizationV1CollectionNamespacedRole(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles" bind Method.DELETE to { req: Request ->
