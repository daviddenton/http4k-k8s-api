 ...
 * 		401 Unauthorized
 */
fun ReplaceCoreV1NamespacedReplicationController(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/replicationcontrollers/{name}" bind Method.PUT to { req: Request ->
