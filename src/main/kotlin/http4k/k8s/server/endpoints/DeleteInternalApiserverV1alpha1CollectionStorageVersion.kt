 ...
 * 		401 Unauthorized
 */
fun DeleteInternalApiserverV1alpha1CollectionStorageVersion(): RoutingHttpHandler {
    ...
    return "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions" bind Method.DELETE to { req: Request ->
