 ...
 * 		401 Unauthorized
 */
fun WatchAutoscalingV1NamespacedHorizontalPodAutoscaler(): RoutingHttpHandler {
	...
	return "/apis/autoscaling/v1/watch/namespaces/{namespace}/horizontalpodautoscalers/{name}" bind Method.GET to { req: Request ->
