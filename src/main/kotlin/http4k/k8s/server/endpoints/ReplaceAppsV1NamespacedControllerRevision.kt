 ...
 * 		401 Unauthorized
 */
fun ReplaceAppsV1NamespacedControllerRevision(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}" bind Method.PUT to { req: Request ->
