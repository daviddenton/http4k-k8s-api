 ...
 * 		401 Unauthorized
 */
fun WatchApiextensionsV1CustomResourceDefinition(): RoutingHttpHandler {
    ...
    return "/apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions/{name}" bind Method.GET to { req: Request ->
