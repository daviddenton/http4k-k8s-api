 ...
 * 		401 Unauthorized
 */
fun DeleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscaler(): RoutingHttpHandler {
	...
	return "/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers" bind Method.DELETE to { req: Request ->
