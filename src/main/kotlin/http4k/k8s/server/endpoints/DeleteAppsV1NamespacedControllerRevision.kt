 ...
 * 		401 Unauthorized
 */
fun DeleteAppsV1NamespacedControllerRevision(): RoutingHttpHandler {
	...
	return "/apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}" bind Method.DELETE to { req: Request ->
