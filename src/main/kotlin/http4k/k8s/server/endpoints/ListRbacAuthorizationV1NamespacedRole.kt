 ...
 * 		401 Unauthorized
 */
fun ListRbacAuthorizationV1NamespacedRole(): RoutingHttpHandler {
	...
	return "/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles" bind Method.GET to { req: Request ->
