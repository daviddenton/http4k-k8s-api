 ...
 * 		401 Unauthorized
 */
fun WatchPolicyV1NamespacedPodDisruptionBudget(): RoutingHttpHandler {
	...
	return "/apis/policy/v1/watch/namespaces/{namespace}/poddisruptionbudgets/{name}" bind Method.GET to { req: Request ->
