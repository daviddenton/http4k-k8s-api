 ...
 * 		401 Unauthorized
 */
fun DeleteInternalApiserverV1alpha1StorageVersion(): RoutingHttpHandler {
    ...
    return "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}" bind Method.DELETE to { req: Request ->
