 ...
 * 		401 Unauthorized
 */
fun WatchAdmissionregistrationV1MutatingWebhookConfiguration(): RoutingHttpHandler {
	...
	return "/apis/admissionregistration.k8s.io/v1/watch/mutatingwebhookconfigurations/{name}" bind Method.GET to { req: Request ->
