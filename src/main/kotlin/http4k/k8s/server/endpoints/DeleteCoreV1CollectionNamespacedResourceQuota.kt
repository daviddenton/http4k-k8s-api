 ...
 * 		401 Unauthorized
 */
fun DeleteCoreV1CollectionNamespacedResourceQuota(): RoutingHttpHandler {
    ...
    return "/api/v1/namespaces/{namespace}/resourcequotas" bind Method.DELETE to { req: Request ->
