 ...
 * 		401 Unauthorized
 */
fun PatchFlowcontrolApiserverV1beta3PriorityLevelConfigurationStatus(): RoutingHttpHandler {
    ...
    return "/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/{name}/status" bind Method.PATCH to { req: Request ->
