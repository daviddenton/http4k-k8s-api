 ...
 * 		401 Unauthorized
 */
fun ListNodeV1RuntimeClass(): RoutingHttpHandler {
    ...
    return "/apis/node.k8s.io/v1/runtimeclasses" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapinodev1RuntimeClassListLens of TODO())
    }
}
