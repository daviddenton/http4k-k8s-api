 ...
 * 		401 Unauthorized
 */
fun WatchResourceV1alpha1PodSchedulingListForAllNamespaces(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/watch/podschedulings" bind Method.GET to { req: Request ->
