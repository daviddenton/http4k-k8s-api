 ...
 * 		401 Unauthorized
 */
fun DeleteCoreV1CollectionNamespacedPersistentVolumeClaim(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/persistentvolumeclaims" bind Method.DELETE to { req: Request ->
