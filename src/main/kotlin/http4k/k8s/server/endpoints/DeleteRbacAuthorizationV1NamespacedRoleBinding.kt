 ...
 * 		401 Unauthorized
 */
fun DeleteRbacAuthorizationV1NamespacedRoleBinding(): RoutingHttpHandler {
	...
	return "/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings/{name}" bind Method.DELETE to { req: Request ->
