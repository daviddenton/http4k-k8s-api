 ...
 * 		401 Unauthorized
 */
fun ReadApiregistrationV1APIServiceStatus(): RoutingHttpHandler {
	val iok8skubeaggregatorpkgapisapiregistrationv1APIServiceLens = Body.auto<APIService>().toLens()
	val nameLens = Path.string().of("name")
	val prettyLens = Query.string().optional("pretty")

	return "/apis/apiregistration.k8s.io/v1/apiservices/{name}/status" bind Method.GET to { req: Request ->
