 ...
 * 		401 Unauthorized
 */
fun PatchPolicyV1NamespacedPodDisruptionBudgetStatus(): RoutingHttpHandler {
	...
	return "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}/status" bind Method.PATCH to { req: Request ->
