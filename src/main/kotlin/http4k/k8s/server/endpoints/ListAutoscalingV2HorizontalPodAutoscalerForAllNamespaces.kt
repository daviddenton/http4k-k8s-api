 ...
 * 		401 Unauthorized
 */
fun ListAutoscalingV2HorizontalPodAutoscalerForAllNamespaces(): RoutingHttpHandler {
    ...
    return "/apis/autoscaling/v2/horizontalpodautoscalers" bind Method.GET to { req: Request ->
