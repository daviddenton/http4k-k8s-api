 ...
 * 		401 Unauthorized
 */
fun ReplaceRbacAuthorizationV1NamespacedRole(): RoutingHttpHandler {
	...
	return "/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles/{name}" bind Method.PUT to { req: Request ->
