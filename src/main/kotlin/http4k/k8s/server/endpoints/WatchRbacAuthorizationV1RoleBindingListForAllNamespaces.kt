 ...
 * 		401 Unauthorized
 */
fun WatchRbacAuthorizationV1RoleBindingListForAllNamespaces(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/watch/rolebindings" bind Method.GET to { req: Request ->
