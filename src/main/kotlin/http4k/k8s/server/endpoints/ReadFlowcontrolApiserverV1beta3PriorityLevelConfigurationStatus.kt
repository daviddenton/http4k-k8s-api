 ...
 * 		401 Unauthorized
 */
fun ReadFlowcontrolApiserverV1beta3PriorityLevelConfigurationStatus(): RoutingHttpHandler {
    val iok8sapiflowcontrolv1beta3PriorityLevelConfigurationLens =
        Body.auto<PriorityLevelConfiguration>().toLens()
    val nameLens = Path.string().of("name")
    val prettyLens = Query.string().optional("pretty")

    return "/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/{name}/status" bind Method.GET to { req: Request ->
