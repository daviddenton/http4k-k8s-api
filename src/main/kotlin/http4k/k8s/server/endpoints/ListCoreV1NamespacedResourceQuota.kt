 ...
 * 		401 Unauthorized
 */
fun ListCoreV1NamespacedResourceQuota(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/resourcequotas" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapicorev1ResourceQuotaListLens of TODO())
	}
}
