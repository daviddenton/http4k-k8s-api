 ...
 * 		401 Unauthorized
 */
fun ListCertificatesV1CertificateSigningRequest(): RoutingHttpHandler {
	...
	return "/apis/certificates.k8s.io/v1/certificatesigningrequests" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapicertificatesv1CertificateSigningRequestListLens of TODO())
	}
}
