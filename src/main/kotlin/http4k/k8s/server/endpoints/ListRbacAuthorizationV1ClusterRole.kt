 ...
 * 		401 Unauthorized
 */
fun ListRbacAuthorizationV1ClusterRole(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/clusterroles" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapirbacv1ClusterRoleListLens of TODO())
    }
}
