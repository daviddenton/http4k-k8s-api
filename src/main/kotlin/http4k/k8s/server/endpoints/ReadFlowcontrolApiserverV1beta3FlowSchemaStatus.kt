 ...
 * 		401 Unauthorized
 */
fun ReadFlowcontrolApiserverV1beta3FlowSchemaStatus(): RoutingHttpHandler {
    val iok8sapiflowcontrolv1beta3FlowSchemaLens = Body.auto<FlowSchema>().toLens()
    val nameLens = Path.string().of("name")
    val prettyLens = Query.string().optional("pretty")

    return "/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}/status" bind Method.GET to { req: Request ->
