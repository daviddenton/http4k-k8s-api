 ...
 * 		401 Unauthorized
 */
fun WatchInternalApiserverV1alpha1StorageVersion(): RoutingHttpHandler {
    ...
    return "/apis/internal.apiserver.k8s.io/v1alpha1/watch/storageversions/{name}" bind Method.GET to { req: Request ->
