 ...
 * 		401 Unauthorized
 */
fun WatchPolicyV1PodDisruptionBudgetListForAllNamespaces(): RoutingHttpHandler {
    ...
    return "/apis/policy/v1/watch/poddisruptionbudgets" bind Method.GET to { req: Request ->
