 ...
 * 		401 Unauthorized
 */
fun DeleteResourceV1alpha1CollectionNamespacedPodScheduling(): RoutingHttpHandler {
    ...
    return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings" bind Method.DELETE to { req: Request ->
