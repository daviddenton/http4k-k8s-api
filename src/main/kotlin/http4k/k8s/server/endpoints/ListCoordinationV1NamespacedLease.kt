 ...
 * 		401 Unauthorized
 */
fun ListCoordinationV1NamespacedLease(): RoutingHttpHandler {
    ...
    return "/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapicoordinationv1LeaseListLens of TODO())
    }
}
