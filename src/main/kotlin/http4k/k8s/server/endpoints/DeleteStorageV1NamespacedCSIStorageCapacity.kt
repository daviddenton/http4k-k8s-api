 ...
 * 		401 Unauthorized
 */
fun DeleteStorageV1NamespacedCSIStorageCapacity(): RoutingHttpHandler {
    ...
    return "/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities/{name}" bind Method.DELETE to { req: Request ->
