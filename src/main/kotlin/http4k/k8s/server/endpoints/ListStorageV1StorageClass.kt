 ...
 * 		401 Unauthorized
 */
fun ListStorageV1StorageClass(): RoutingHttpHandler {
    ...
    return "/apis/storage.k8s.io/v1/storageclasses" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapistoragev1StorageClassListLens of TODO())
    }
}
