 ...
 * 		401 Unauthorized
 */
fun PatchStorageV1NamespacedCSIStorageCapacity(): RoutingHttpHandler {
	...
	return "/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities/{name}" bind Method.PATCH to { req: Request ->
