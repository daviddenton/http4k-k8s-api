 ...
 * 		401 Unauthorized
 */
fun DeletePolicyV1CollectionNamespacedPodDisruptionBudget(): RoutingHttpHandler {
	...
	return "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets" bind Method.DELETE to { req: Request ->
