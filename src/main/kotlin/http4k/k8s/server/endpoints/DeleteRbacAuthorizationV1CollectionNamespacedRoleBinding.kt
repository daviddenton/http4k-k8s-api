 ...
 * 		401 Unauthorized
 */
fun DeleteRbacAuthorizationV1CollectionNamespacedRoleBinding(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings" bind Method.DELETE to { req: Request ->
