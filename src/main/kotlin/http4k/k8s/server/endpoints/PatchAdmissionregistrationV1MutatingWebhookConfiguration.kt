 ...
 * 		401 Unauthorized
 */
fun PatchAdmissionregistrationV1MutatingWebhookConfiguration(): RoutingHttpHandler {
    ...
    return "/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{name}" bind Method.PATCH to { req: Request ->
