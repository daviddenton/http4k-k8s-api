 ...
 * 		401 Unauthorized
 */
fun DeleteFlowcontrolApiserverV1beta2PriorityLevelConfiguration(): RoutingHttpHandler {
    ...
    return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations/{name}" bind Method.DELETE to { req: Request ->
