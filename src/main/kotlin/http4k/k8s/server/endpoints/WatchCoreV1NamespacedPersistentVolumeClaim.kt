 ...
 * 		401 Unauthorized
 */
fun WatchCoreV1NamespacedPersistentVolumeClaim(): RoutingHttpHandler {
    ...
    return "/api/v1/watch/namespaces/{namespace}/persistentvolumeclaims/{name}" bind Method.GET to { req: Request ->
