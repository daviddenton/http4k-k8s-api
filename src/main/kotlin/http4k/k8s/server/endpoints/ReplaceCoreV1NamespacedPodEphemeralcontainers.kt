 ...
 * 		401 Unauthorized
 */
fun ReplaceCoreV1NamespacedPodEphemeralcontainers(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/pods/{name}/ephemeralcontainers" bind Method.PUT to { req: Request ->
