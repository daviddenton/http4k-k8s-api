 ...
 * 		401 Unauthorized
 */
fun ListResourceV1alpha1NamespacedPodScheduling(): RoutingHttpHandler {
    ...
    return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapiresourcev1alpha1PodSchedulingListLens of TODO())
    }
}
