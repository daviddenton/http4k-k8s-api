 ...
 * 		401 Unauthorized
 */
fun DeleteCoordinationV1NamespacedLease(): RoutingHttpHandler {
    ...
    return "/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases/{name}" bind Method.DELETE to { req: Request ->
