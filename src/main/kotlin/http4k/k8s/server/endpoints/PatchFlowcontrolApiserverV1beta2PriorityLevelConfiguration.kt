 ...
 * 		401 Unauthorized
 */
fun PatchFlowcontrolApiserverV1beta2PriorityLevelConfiguration(): RoutingHttpHandler {
    ...
    return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations/{name}" bind Method.PATCH to { req: Request ->
