 ...
 * 		401 Unauthorized
 */
fun PatchNetworkingV1NamespacedIngressStatus(): RoutingHttpHandler {
	...
	return "/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}/status" bind Method.PATCH to { req: Request ->
