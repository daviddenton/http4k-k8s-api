 ...
 * 		401 Unauthorized
 */
fun WatchFlowcontrolApiserverV1beta3FlowSchemaList(): RoutingHttpHandler {
	...
	return "/apis/flowcontrol.apiserver.k8s.io/v1beta3/watch/flowschemas" bind Method.GET to { req: Request ->
