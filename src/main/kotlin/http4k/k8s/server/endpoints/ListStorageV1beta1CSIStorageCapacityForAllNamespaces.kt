 ...
 * 		401 Unauthorized
 */
fun ListStorageV1beta1CSIStorageCapacityForAllNamespaces(): RoutingHttpHandler {
	...
	return "/apis/storage.k8s.io/v1beta1/csistoragecapacities" bind Method.GET to { req: Request ->
