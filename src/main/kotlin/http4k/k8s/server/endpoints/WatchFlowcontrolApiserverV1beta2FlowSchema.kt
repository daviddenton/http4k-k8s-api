 ...
 * 		401 Unauthorized
 */
fun WatchFlowcontrolApiserverV1beta2FlowSchema(): RoutingHttpHandler {
	...
	return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/watch/flowschemas/{name}" bind Method.GET to { req: Request ->
