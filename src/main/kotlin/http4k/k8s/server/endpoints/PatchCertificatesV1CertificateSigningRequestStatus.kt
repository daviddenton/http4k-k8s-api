 ...
 * 		401 Unauthorized
 */
fun PatchCertificatesV1CertificateSigningRequestStatus(): RoutingHttpHandler {
    ...
    return "/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}/status" bind Method.PATCH to { req: Request ->
