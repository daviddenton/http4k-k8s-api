 ...
 * 		401 Unauthorized
 */
fun PatchAdmissionregistrationV1alpha1ValidatingAdmissionPolicy(): RoutingHttpHandler {
    ...
    return "/apis/admissionregistration.k8s.io/v1alpha1/validatingadmissionpolicies/{name}" bind Method.PATCH to { req: Request ->
