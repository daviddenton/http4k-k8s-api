 ...
 * 		401 Unauthorized
 */
fun PatchResourceV1alpha1NamespacedResourceClaimStatus(): RoutingHttpHandler {
    ...
    return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}/status" bind Method.PATCH to { req: Request ->
