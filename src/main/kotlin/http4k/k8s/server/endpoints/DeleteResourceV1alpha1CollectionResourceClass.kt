 ...
 * 		401 Unauthorized
 */
fun DeleteResourceV1alpha1CollectionResourceClass(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/resourceclasses" bind Method.DELETE to { req: Request ->
