 ...
 * 		401 Unauthorized
 */
fun ListCoreV1NamespacedPersistentVolumeClaim(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/persistentvolumeclaims" bind Method.GET to { req: Request ->
