 ...
 * 		401 Unauthorized
 */
fun PatchCoordinationV1NamespacedLease(): RoutingHttpHandler {
	...
	return "/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases/{name}" bind Method.PATCH to { req: Request ->
