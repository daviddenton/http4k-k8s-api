 ...
 * 		401 Unauthorized
 */
fun WatchFlowcontrolApiserverV1beta3PriorityLevelConfiguration(): RoutingHttpHandler {
	...
	return "/apis/flowcontrol.apiserver.k8s.io/v1beta3/watch/prioritylevelconfigurations/{name}" bind Method.GET to { req: Request ->
