 ...
 * 		401 Unauthorized
 */
fun DeleteDiscoveryV1NamespacedEndpointSlice(): RoutingHttpHandler {
    ...
    return "/apis/discovery.k8s.io/v1/namespaces/{namespace}/endpointslices/{name}" bind Method.DELETE to { req: Request ->
