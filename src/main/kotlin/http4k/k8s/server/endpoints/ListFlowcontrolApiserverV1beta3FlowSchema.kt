...
import http4k.k8s.model.io.k8s.api.flowcontrol.v1beta3.FlowSchemaList
 ...
 * 		401 Unauthorized
 */
fun ListFlowcontrolApiserverV1beta3FlowSchema(): RoutingHttpHandler {
    val iok8sapiflowcontrolv1beta3FlowSchemaListLens = Body.auto<FlowSchemaList>().toLens()
    ...
    return "/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapiflowcontrolv1beta3FlowSchemaListLens of TODO())
    }
}
