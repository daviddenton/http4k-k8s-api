 ...
 * 		401 Unauthorized
 */
fun ListNetworkingV1alpha1ClusterCIDR(): RoutingHttpHandler {
    ...
    return "/apis/networking.k8s.io/v1alpha1/clustercidrs" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapinetworkingv1alpha1ClusterCIDRListLens of TODO())
    }
}
