 ...
 * 		401 Unauthorized
 */
fun WatchResourceV1alpha1NamespacedResourceClaimList(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/watch/namespaces/{namespace}/resourceclaims" bind Method.GET to { req: Request ->
