 ...
 * 		401 Unauthorized
 */
fun WatchAutoscalingV1NamespacedHorizontalPodAutoscalerList(): RoutingHttpHandler {
	...
	return "/apis/autoscaling/v1/watch/namespaces/{namespace}/horizontalpodautoscalers" bind Method.GET to { req: Request ->
