 ...
 * 		401 Unauthorized
 */
fun DeleteAdmissionregistrationV1MutatingWebhookConfiguration(): RoutingHttpHandler {
    ...
    return "/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{name}" bind Method.DELETE to { req: Request ->
