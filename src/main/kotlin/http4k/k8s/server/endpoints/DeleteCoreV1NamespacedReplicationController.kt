 ...
 * 		401 Unauthorized
 */
fun DeleteCoreV1NamespacedReplicationController(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/replicationcontrollers/{name}" bind Method.DELETE to { req: Request ->
