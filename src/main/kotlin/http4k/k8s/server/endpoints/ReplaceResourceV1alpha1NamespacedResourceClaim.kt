 ...
 * 		401 Unauthorized
 */
fun ReplaceResourceV1alpha1NamespacedResourceClaim(): RoutingHttpHandler {
    ...
    return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}" bind Method.PUT to { req: Request ->
