 ...
 * 		401 Unauthorized
 */
fun PatchAutoscalingV1NamespacedHorizontalPodAutoscaler(): RoutingHttpHandler {
	...
	return "/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}" bind Method.PATCH to { req: Request ->
