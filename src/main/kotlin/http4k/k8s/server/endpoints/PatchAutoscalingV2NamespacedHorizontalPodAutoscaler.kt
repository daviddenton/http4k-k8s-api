 ...
 * 		401 Unauthorized
 */
fun PatchAutoscalingV2NamespacedHorizontalPodAutoscaler(): RoutingHttpHandler {
    ...
    return "/apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers/{name}" bind Method.PATCH to { req: Request ->
