 ...
 * 		401 Unauthorized
 */
fun WatchRbacAuthorizationV1ClusterRoleBindingList(): RoutingHttpHandler {
	...
	return "/apis/rbac.authorization.k8s.io/v1/watch/clusterrolebindings" bind Method.GET to { req: Request ->
