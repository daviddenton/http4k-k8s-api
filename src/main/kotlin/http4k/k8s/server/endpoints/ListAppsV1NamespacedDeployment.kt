 ...
 * 		401 Unauthorized
 */
fun ListAppsV1NamespacedDeployment(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/namespaces/{namespace}/deployments" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapiappsv1DeploymentListLens of TODO())
    }
}
