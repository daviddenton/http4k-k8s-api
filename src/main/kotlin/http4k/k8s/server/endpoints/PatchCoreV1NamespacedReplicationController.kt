 ...
 * 		401 Unauthorized
 */
fun PatchCoreV1NamespacedReplicationController(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/replicationcontrollers/{name}" bind Method.PATCH to { req: Request ->
