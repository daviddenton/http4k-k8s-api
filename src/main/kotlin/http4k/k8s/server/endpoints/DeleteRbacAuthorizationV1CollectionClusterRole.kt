 ...
 * 		401 Unauthorized
 */
fun DeleteRbacAuthorizationV1CollectionClusterRole(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/clusterroles" bind Method.DELETE to { req: Request ->
