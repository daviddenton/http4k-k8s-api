 ...
 * 		401 Unauthorized
 */
fun WatchRbacAuthorizationV1NamespacedRoleList(): RoutingHttpHandler {
	...
	return "/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/roles" bind Method.GET to { req: Request ->
