 ...
 * 		401 Unauthorized
 */
fun WatchAdmissionregistrationV1alpha1ValidatingAdmissionPolicy(): RoutingHttpHandler {
    ...
    return "/apis/admissionregistration.k8s.io/v1alpha1/watch/validatingadmissionpolicies/{name}" bind Method.GET to { req: Request ->
