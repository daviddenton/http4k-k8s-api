 ...
 * 		401 Unauthorized
 */
fun WatchResourceV1alpha1NamespacedPodSchedulingList(): RoutingHttpHandler {
    ...
    return "/apis/resource.k8s.io/v1alpha1/watch/namespaces/{namespace}/podschedulings" bind Method.GET to { req: Request ->
