 ...
 * 		401 Unauthorized
 */
fun ListStorageV1CSINode(): RoutingHttpHandler {
	...
	return "/apis/storage.k8s.io/v1/csinodes" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapistoragev1CSINodeListLens of TODO())
	}
}
