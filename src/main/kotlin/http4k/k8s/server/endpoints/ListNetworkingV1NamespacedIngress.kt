 ...
 * 		401 Unauthorized
 */
fun ListNetworkingV1NamespacedIngress(): RoutingHttpHandler {
	...
	return "/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapinetworkingv1IngressListLens of TODO())
	}
}
