 ...
 * 		401 Unauthorized
 */
fun ReplaceBatchV1NamespacedCronJobStatus(): RoutingHttpHandler {
	...
	return "/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}/status" bind Method.PUT to { req: Request ->
