 ...
 * 		401 Unauthorized
 */
fun PatchAppsV1NamespacedStatefulSetStatus(): RoutingHttpHandler {
	...
	return "/apis/apps/v1/namespaces/{namespace}/statefulsets/{name}/status" bind Method.PATCH to { req: Request ->
