 ...
 * 		401 Unauthorized
 */
fun ListAppsV1NamespacedControllerRevision(): RoutingHttpHandler {
	...
	return "/apis/apps/v1/namespaces/{namespace}/controllerrevisions" bind Method.GET to { req: Request ->
