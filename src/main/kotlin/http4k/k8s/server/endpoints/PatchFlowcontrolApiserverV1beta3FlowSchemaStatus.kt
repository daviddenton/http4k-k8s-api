 ...
 * 		401 Unauthorized
 */
fun PatchFlowcontrolApiserverV1beta3FlowSchemaStatus(): RoutingHttpHandler {
    ...
    return "/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}/status" bind Method.PATCH to { req: Request ->
