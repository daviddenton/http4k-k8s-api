 ...
 * 		401 Unauthorized
 */
fun WatchAutoscalingV2NamespacedHorizontalPodAutoscaler(): RoutingHttpHandler {
	...
	return "/apis/autoscaling/v2/watch/namespaces/{namespace}/horizontalpodautoscalers/{name}" bind Method.GET to { req: Request ->
