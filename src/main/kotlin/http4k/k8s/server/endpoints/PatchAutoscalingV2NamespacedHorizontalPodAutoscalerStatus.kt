 ...
 * 		401 Unauthorized
 */
fun PatchAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(): RoutingHttpHandler {
    ...
    return "/apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status" bind Method.PATCH to { req: Request ->
