 ...
 * 		401 Unauthorized
 */
fun PatchResourceV1alpha1NamespacedResourceClaimTemplate(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates/{name}" bind Method.PATCH to { req: Request ->
