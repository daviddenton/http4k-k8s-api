 ...
 * 		401 Unauthorized
 */
fun WatchFlowcontrolApiserverV1beta2PriorityLevelConfiguration(): RoutingHttpHandler {
    ...
    return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/watch/prioritylevelconfigurations/{name}" bind Method.GET to { req: Request ->
