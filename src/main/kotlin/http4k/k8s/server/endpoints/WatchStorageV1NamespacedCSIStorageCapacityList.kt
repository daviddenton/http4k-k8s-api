 ...
 * 		401 Unauthorized
 */
fun WatchStorageV1NamespacedCSIStorageCapacityList(): RoutingHttpHandler {
    ...
    return "/apis/storage.k8s.io/v1/watch/namespaces/{namespace}/csistoragecapacities" bind Method.GET to { req: Request ->
