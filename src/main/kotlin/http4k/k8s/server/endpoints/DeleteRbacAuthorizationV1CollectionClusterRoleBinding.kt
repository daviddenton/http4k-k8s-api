 ...
 * 		401 Unauthorized
 */
fun DeleteRbacAuthorizationV1CollectionClusterRoleBinding(): RoutingHttpHandler {
	...
	return "/apis/rbac.authorization.k8s.io/v1/clusterrolebindings" bind Method.DELETE to { req: Request ->
