 ...
 * 		401 Unauthorized
 */
fun WatchRbacAuthorizationV1RoleListForAllNamespaces(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/watch/roles" bind Method.GET to { req: Request ->
