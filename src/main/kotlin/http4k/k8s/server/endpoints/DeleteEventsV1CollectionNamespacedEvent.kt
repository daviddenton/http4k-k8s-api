 ...
 * 		401 Unauthorized
 */
fun DeleteEventsV1CollectionNamespacedEvent(): RoutingHttpHandler {
	...
	return "/apis/events.k8s.io/v1/namespaces/{namespace}/events" bind Method.DELETE to { req: Request ->
