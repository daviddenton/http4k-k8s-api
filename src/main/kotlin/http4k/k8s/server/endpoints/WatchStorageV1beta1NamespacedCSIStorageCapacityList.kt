 ...
 * 		401 Unauthorized
 */
fun WatchStorageV1beta1NamespacedCSIStorageCapacityList(): RoutingHttpHandler {
    ...
    return "/apis/storage.k8s.io/v1beta1/watch/namespaces/{namespace}/csistoragecapacities" bind Method.GET to { req: Request ->
