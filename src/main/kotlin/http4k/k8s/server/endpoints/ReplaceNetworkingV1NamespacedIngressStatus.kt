 ...
 * 		401 Unauthorized
 */
fun ReplaceNetworkingV1NamespacedIngressStatus(): RoutingHttpHandler {
    ...
    return "/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}/status" bind Method.PUT to { req: Request ->
