 ...
 * 		401 Unauthorized
 */
fun WatchStorageV1CSIStorageCapacityListForAllNamespaces(): RoutingHttpHandler {
    ...
    return "/apis/storage.k8s.io/v1/watch/csistoragecapacities" bind Method.GET to { req: Request ->
