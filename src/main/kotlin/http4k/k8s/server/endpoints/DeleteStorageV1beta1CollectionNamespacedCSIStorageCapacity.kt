 ...
 * 		401 Unauthorized
 */
fun DeleteStorageV1beta1CollectionNamespacedCSIStorageCapacity(): RoutingHttpHandler {
	...
	return "/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities" bind Method.DELETE to { req: Request ->
