 ...
 * 		401 Unauthorized
 */
fun WatchCoreV1NamespacedReplicationControllerList(): RoutingHttpHandler {
    ...
    return "/api/v1/watch/namespaces/{namespace}/replicationcontrollers" bind Method.GET to { req: Request ->
