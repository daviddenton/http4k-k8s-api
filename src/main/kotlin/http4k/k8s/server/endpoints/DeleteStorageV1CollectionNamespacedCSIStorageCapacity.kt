 ...
 * 		401 Unauthorized
 */
fun DeleteStorageV1CollectionNamespacedCSIStorageCapacity(): RoutingHttpHandler {
    ...
    return "/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities" bind Method.DELETE to { req: Request ->
