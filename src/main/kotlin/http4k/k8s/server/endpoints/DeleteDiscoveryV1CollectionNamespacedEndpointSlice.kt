 ...
 * 		401 Unauthorized
 */
fun DeleteDiscoveryV1CollectionNamespacedEndpointSlice(): RoutingHttpHandler {
    ...
    return "/apis/discovery.k8s.io/v1/namespaces/{namespace}/endpointslices" bind Method.DELETE to { req: Request ->
