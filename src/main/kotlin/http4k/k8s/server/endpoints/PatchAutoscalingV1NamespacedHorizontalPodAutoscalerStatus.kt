 ...
 * 		401 Unauthorized
 */
fun PatchAutoscalingV1NamespacedHorizontalPodAutoscalerStatus(): RoutingHttpHandler {
	...
	return "/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status" bind Method.PATCH to { req: Request ->
