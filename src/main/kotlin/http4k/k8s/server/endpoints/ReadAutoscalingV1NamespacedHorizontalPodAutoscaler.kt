 ...
 * 		401 Unauthorized
 */
fun ReadAutoscalingV1NamespacedHorizontalPodAutoscaler(): RoutingHttpHandler {
	...
	return "/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}" bind Method.GET to { req: Request ->
