 ...
 * 		401 Unauthorized
 */
fun ReadAppsV1NamespacedDeploymentScale(): RoutingHttpHandler {
    val iok8sapiautoscalingv1ScaleLens = Body.auto<Scale>().toLens()
    val nameLens = Path.string().of("name")
    val namespaceLens = Path.string().of("namespace")
    val prettyLens = Query.string().optional("pretty")

    return "/apis/apps/v1/namespaces/{namespace}/deployments/{name}/scale" bind Method.GET to { req: Request ->
