 ...
 * 		401 Unauthorized
 */
fun ListBatchV1NamespacedJob(): RoutingHttpHandler {
	...
	return "/apis/batch/v1/namespaces/{namespace}/jobs" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapibatchv1JobListLens of TODO())
	}
}
