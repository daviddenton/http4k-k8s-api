 ...
 * 		401 Unauthorized
 */
fun DeleteFlowcontrolApiserverV1beta3PriorityLevelConfiguration(): RoutingHttpHandler {
    ...
    return "/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/{name}" bind Method.DELETE to { req: Request ->
