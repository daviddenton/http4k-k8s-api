 ...
 * 		401 Unauthorized
 */
fun PatchNetworkingV1NamespacedIngress(): RoutingHttpHandler {
    ...
    return "/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}" bind Method.PATCH to { req: Request ->
