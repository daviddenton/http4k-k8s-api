 ...
 * 		401 Unauthorized
 */
fun WatchPolicyV1NamespacedPodDisruptionBudgetList(): RoutingHttpHandler {
	...
	return "/apis/policy/v1/watch/namespaces/{namespace}/poddisruptionbudgets" bind Method.GET to { req: Request ->
