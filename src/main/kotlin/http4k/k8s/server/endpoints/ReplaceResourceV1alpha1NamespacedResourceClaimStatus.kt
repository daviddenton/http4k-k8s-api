 ...
 * 		401 Unauthorized
 */
fun ReplaceResourceV1alpha1NamespacedResourceClaimStatus(): RoutingHttpHandler {
    ...
    return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}/status" bind Method.PUT to { req: Request ->
