 ...
 * 		401 Unauthorized
 */
fun ListAdmissionregistrationV1MutatingWebhookConfiguration(): RoutingHttpHandler {
    ...
    return "/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapiadmissionregistrationv1MutatingWebhookConfigurationListLens of TODO())
    }
}
