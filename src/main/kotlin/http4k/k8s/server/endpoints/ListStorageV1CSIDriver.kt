 ...
 * 		401 Unauthorized
 */
fun ListStorageV1CSIDriver(): RoutingHttpHandler {
    ...
    return "/apis/storage.k8s.io/v1/csidrivers" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapistoragev1CSIDriverListLens of TODO())
    }
}
