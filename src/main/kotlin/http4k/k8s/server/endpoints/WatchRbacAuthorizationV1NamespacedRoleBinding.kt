 ...
 * 		401 Unauthorized
 */
fun WatchRbacAuthorizationV1NamespacedRoleBinding(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/rolebindings/{name}" bind Method.GET to { req: Request ->
