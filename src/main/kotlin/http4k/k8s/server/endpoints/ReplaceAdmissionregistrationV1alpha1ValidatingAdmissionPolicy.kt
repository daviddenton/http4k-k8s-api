 ...
 * 		401 Unauthorized
 */
fun ReplaceAdmissionregistrationV1alpha1ValidatingAdmissionPolicy(): RoutingHttpHandler {
	...
	return "/apis/admissionregistration.k8s.io/v1alpha1/validatingadmissionpolicies/{name}" bind Method.PUT to { req: Request ->
