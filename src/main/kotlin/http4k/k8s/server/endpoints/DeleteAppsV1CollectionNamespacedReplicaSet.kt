 ...
 * 		401 Unauthorized
 */
fun DeleteAppsV1CollectionNamespacedReplicaSet(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/namespaces/{namespace}/replicasets" bind Method.DELETE to { req: Request ->
