...
import http4k.k8s.model.io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerList
 ...
 * 		401 Unauthorized
 */
fun ListAutoscalingV2NamespacedHorizontalPodAutoscaler(): RoutingHttpHandler {
	...
	return "/apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapiautoscalingv2HorizontalPodAutoscalerListLens of TODO())
	}
}
