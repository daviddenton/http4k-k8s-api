 ...
 * 		401 Unauthorized
 */
fun PatchDiscoveryV1NamespacedEndpointSlice(): RoutingHttpHandler {
	...
	return "/apis/discovery.k8s.io/v1/namespaces/{namespace}/endpointslices/{name}" bind Method.PATCH to { req: Request ->
