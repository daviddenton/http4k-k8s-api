 ...
 * 		401 Unauthorized
 */
fun PatchApiextensionsV1CustomResourceDefinition(): RoutingHttpHandler {
	...
	return "/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}" bind Method.PATCH to { req: Request ->
