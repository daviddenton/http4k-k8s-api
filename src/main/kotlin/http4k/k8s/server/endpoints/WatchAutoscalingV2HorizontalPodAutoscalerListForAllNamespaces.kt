 ...
 * 		401 Unauthorized
 */
fun WatchAutoscalingV2HorizontalPodAutoscalerListForAllNamespaces(): RoutingHttpHandler {
	...
	return "/apis/autoscaling/v2/watch/horizontalpodautoscalers" bind Method.GET to { req: Request ->
