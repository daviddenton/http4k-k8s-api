 ...
 * 		401 Unauthorized
 */
fun WatchResourceV1alpha1ResourceClassList(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/watch/resourceclasses" bind Method.GET to { req: Request ->
