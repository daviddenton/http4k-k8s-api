 ...
 * 		401 Unauthorized
 */
fun ListCoreV1NamespacedConfigMap(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/configmaps" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapicorev1ConfigMapListLens of TODO())
	}
}
