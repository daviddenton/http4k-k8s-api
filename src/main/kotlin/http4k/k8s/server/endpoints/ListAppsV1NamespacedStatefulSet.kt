 ...
 * 		401 Unauthorized
 */
fun ListAppsV1NamespacedStatefulSet(): RoutingHttpHandler {
	...
	return "/apis/apps/v1/namespaces/{namespace}/statefulsets" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapiappsv1StatefulSetListLens of TODO())
	}
}
