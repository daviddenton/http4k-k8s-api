 ...
 * 		401 Unauthorized
 */
fun ListStorageV1NamespacedCSIStorageCapacity(): RoutingHttpHandler {
	...
	return "/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities" bind Method.GET to { req: Request ->
