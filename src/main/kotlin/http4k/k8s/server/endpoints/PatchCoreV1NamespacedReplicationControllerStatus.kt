 ...
 * 		401 Unauthorized
 */
fun PatchCoreV1NamespacedReplicationControllerStatus(): RoutingHttpHandler {
    ...
    return "/api/v1/namespaces/{namespace}/replicationcontrollers/{name}/status" bind Method.PATCH to { req: Request ->
