 ...
 * 		401 Unauthorized
 */
fun PatchAppsV1NamespacedDeploymentScale(): RoutingHttpHandler {
	...
	return "/apis/apps/v1/namespaces/{namespace}/deployments/{name}/scale" bind Method.PATCH to { req: Request ->
