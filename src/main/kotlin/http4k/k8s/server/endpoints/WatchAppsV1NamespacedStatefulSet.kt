 ...
 * 		401 Unauthorized
 */
fun WatchAppsV1NamespacedStatefulSet(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/watch/namespaces/{namespace}/statefulsets/{name}" bind Method.GET to { req: Request ->
