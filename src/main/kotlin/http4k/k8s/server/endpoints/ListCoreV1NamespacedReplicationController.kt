 ...
 * 		401 Unauthorized
 */
fun ListCoreV1NamespacedReplicationController(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/replicationcontrollers" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapicorev1ReplicationControllerListLens of TODO())
	}
}
