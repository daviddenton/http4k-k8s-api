 ...
 * 		401 Unauthorized
 */
fun WatchStorageV1beta1CSIStorageCapacityListForAllNamespaces(): RoutingHttpHandler {
    ...
    return "/apis/storage.k8s.io/v1beta1/watch/csistoragecapacities" bind Method.GET to { req: Request ->
