 ...
 * 		401 Unauthorized
 */
fun ReplaceInternalApiserverV1alpha1StorageVersion(): RoutingHttpHandler {
    ...
    return "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}" bind Method.PUT to { req: Request ->
