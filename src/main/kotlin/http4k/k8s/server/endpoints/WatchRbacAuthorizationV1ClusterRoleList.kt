 ...
 * 		401 Unauthorized
 */
fun WatchRbacAuthorizationV1ClusterRoleList(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/watch/clusterroles" bind Method.GET to { req: Request ->
