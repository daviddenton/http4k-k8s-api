 ...
 * 		401 Unauthorized
 */
fun PatchAppsV1NamespacedControllerRevision(): RoutingHttpHandler {
	...
	return "/apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}" bind Method.PATCH to { req: Request ->
