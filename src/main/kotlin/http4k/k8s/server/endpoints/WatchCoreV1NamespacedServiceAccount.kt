 ...
 * 		401 Unauthorized
 */
fun WatchCoreV1NamespacedServiceAccount(): RoutingHttpHandler {
    ...
    return "/api/v1/watch/namespaces/{namespace}/serviceaccounts/{name}" bind Method.GET to { req: Request ->
