 ...
 * 		401 Unauthorized
 */
fun DeleteNetworkingV1CollectionNamespacedIngress(): RoutingHttpHandler {
    ...
    return "/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses" bind Method.DELETE to { req: Request ->
