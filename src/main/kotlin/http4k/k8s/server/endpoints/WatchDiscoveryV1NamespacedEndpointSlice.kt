 ...
 * 		401 Unauthorized
 */
fun WatchDiscoveryV1NamespacedEndpointSlice(): RoutingHttpHandler {
    ...
    return "/apis/discovery.k8s.io/v1/watch/namespaces/{namespace}/endpointslices/{name}" bind Method.GET to { req: Request ->
