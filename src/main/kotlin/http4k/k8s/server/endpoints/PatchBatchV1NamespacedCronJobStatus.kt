 ...
 * 		401 Unauthorized
 */
fun PatchBatchV1NamespacedCronJobStatus(): RoutingHttpHandler {
	...
	return "/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}/status" bind Method.PATCH to { req: Request ->
