 ...
 * 		401 Unauthorized
 */
fun ListAutoscalingV1HorizontalPodAutoscalerForAllNamespaces(): RoutingHttpHandler {
	...
	return "/apis/autoscaling/v1/horizontalpodautoscalers" bind Method.GET to { req: Request ->
