 ...
 * 		401 Unauthorized
 */
fun DeleteResourceV1alpha1CollectionNamespacedResourceClaim(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims" bind Method.DELETE to { req: Request ->
