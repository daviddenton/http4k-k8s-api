 ...
 * 		401 Unauthorized
 */
fun ReplaceRbacAuthorizationV1NamespacedRoleBinding(): RoutingHttpHandler {
	...
	return "/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings/{name}" bind Method.PUT to { req: Request ->
