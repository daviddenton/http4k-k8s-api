 ...
 * 		401 Unauthorized
 */
fun ListCoreV1NamespacedLimitRange(): RoutingHttpHandler {
    ...
    return "/api/v1/namespaces/{namespace}/limitranges" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapicorev1LimitRangeListLens of TODO())
    }
}
