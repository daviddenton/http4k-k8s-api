 ...
 * 		401 Unauthorized
 */
fun WatchCertificatesV1CertificateSigningRequestList(): RoutingHttpHandler {
	...
	return "/apis/certificates.k8s.io/v1/watch/certificatesigningrequests" bind Method.GET to { req: Request ->
