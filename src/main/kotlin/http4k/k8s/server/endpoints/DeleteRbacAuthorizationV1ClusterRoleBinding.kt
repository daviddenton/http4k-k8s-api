 ...
 * 		401 Unauthorized
 */
fun DeleteRbacAuthorizationV1ClusterRoleBinding(): RoutingHttpHandler {
	...
	return "/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}" bind Method.DELETE to { req: Request ->
