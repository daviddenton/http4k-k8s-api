 ...
 * 		401 Unauthorized
 */
fun DeleteFlowcontrolApiserverV1beta3FlowSchema(): RoutingHttpHandler {
	...
	return "/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}" bind Method.DELETE to { req: Request ->
