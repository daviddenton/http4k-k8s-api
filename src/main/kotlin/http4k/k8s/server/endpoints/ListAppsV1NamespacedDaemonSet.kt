 ...
 * 		401 Unauthorized
 */
fun ListAppsV1NamespacedDaemonSet(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/namespaces/{namespace}/daemonsets" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapiappsv1DaemonSetListLens of TODO())
    }
}
