 ...
 * 		401 Unauthorized
 */
fun DeleteRbacAuthorizationV1ClusterRole(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/clusterroles/{name}" bind Method.DELETE to { req: Request ->
