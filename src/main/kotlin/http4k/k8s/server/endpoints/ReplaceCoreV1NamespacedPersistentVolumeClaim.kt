 ...
 * 		401 Unauthorized
 */
fun ReplaceCoreV1NamespacedPersistentVolumeClaim(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/persistentvolumeclaims/{name}" bind Method.PUT to { req: Request ->
