 ...
 * 		401 Unauthorized
 */
fun PatchFlowcontrolApiserverV1beta3FlowSchema(): RoutingHttpHandler {
    ...
    return "/apis/flowcontrol.apiserver.k8s.io/v1beta3/flowschemas/{name}" bind Method.PATCH to { req: Request ->
