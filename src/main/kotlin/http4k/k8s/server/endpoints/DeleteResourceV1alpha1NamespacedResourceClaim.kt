 ...
 * 		401 Unauthorized
 */
fun DeleteResourceV1alpha1NamespacedResourceClaim(): RoutingHttpHandler {
    ...
    return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}" bind Method.DELETE to { req: Request ->
