 ...
 * 		401 Unauthorized
 */
fun ListResourceV1alpha1NamespacedResourceClaim(): RoutingHttpHandler {
    ...
    return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims" bind Method.GET to { req: Request ->
