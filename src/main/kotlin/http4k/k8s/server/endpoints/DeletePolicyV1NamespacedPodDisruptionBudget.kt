 ...
 * 		401 Unauthorized
 */
fun DeletePolicyV1NamespacedPodDisruptionBudget(): RoutingHttpHandler {
    ...
    return "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}" bind Method.DELETE to { req: Request ->
