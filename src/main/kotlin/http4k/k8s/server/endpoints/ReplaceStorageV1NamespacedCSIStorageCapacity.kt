 ...
 * 		401 Unauthorized
 */
fun ReplaceStorageV1NamespacedCSIStorageCapacity(): RoutingHttpHandler {
	...
	return "/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities/{name}" bind Method.PUT to { req: Request ->
