 ...
 * 		401 Unauthorized
 */
fun PatchCertificatesV1CertificateSigningRequestApproval(): RoutingHttpHandler {
	...
	return "/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}/approval" bind Method.PATCH to { req: Request ->
