 ...
 * 		401 Unauthorized
 */
fun PatchAppsV1NamespacedReplicaSetScale(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/namespaces/{namespace}/replicasets/{name}/scale" bind Method.PATCH to { req: Request ->
