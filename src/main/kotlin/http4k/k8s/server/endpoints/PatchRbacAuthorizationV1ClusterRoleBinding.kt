 ...
 * 		401 Unauthorized
 */
fun PatchRbacAuthorizationV1ClusterRoleBinding(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}" bind Method.PATCH to { req: Request ->
