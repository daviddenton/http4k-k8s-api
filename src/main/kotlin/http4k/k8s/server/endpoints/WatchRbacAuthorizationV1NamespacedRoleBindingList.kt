 ...
 * 		401 Unauthorized
 */
fun WatchRbacAuthorizationV1NamespacedRoleBindingList(): RoutingHttpHandler {
	...
	return "/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/rolebindings" bind Method.GET to { req: Request ->
