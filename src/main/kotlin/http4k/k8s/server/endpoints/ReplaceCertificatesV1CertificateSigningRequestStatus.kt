 ...
 * 		401 Unauthorized
 */
fun ReplaceCertificatesV1CertificateSigningRequestStatus(): RoutingHttpHandler {
    ...
    return "/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}/status" bind Method.PUT to { req: Request ->
