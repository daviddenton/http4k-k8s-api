 ...
 * 		401 Unauthorized
 */
fun ListAutoscalingV1NamespacedHorizontalPodAutoscaler(): RoutingHttpHandler {
    ...
    return "/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapiautoscalingv1HorizontalPodAutoscalerListLens of TODO())
    }
}
