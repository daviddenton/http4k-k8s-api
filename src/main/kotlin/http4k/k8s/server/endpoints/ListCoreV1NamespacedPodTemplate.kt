 ...
 * 		401 Unauthorized
 */
fun ListCoreV1NamespacedPodTemplate(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/podtemplates" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapicorev1PodTemplateListLens of TODO())
	}
}
