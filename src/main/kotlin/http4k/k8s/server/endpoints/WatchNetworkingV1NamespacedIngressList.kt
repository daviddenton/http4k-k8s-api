 ...
 * 		401 Unauthorized
 */
fun WatchNetworkingV1NamespacedIngressList(): RoutingHttpHandler {
    ...
    return "/apis/networking.k8s.io/v1/watch/namespaces/{namespace}/ingresses" bind Method.GET to { req: Request ->
