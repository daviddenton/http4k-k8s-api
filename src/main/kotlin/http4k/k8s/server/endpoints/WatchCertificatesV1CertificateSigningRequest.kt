 ...
 * 		401 Unauthorized
 */
fun WatchCertificatesV1CertificateSigningRequest(): RoutingHttpHandler {
	...
	return "/apis/certificates.k8s.io/v1/watch/certificatesigningrequests/{name}" bind Method.GET to { req: Request ->
