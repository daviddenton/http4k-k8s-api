 ...
 * 		401 Unauthorized
 */
fun PatchFlowcontrolApiserverV1beta2FlowSchema(): RoutingHttpHandler {
	...
	return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}" bind Method.PATCH to { req: Request ->
