 ...
 * 		401 Unauthorized
 */
fun ListAdmissionregistrationV1alpha1ValidatingAdmissionPolicy(): RoutingHttpHandler {
	...
	return "/apis/admissionregistration.k8s.io/v1alpha1/validatingadmissionpolicies" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapiadmissionregistrationv1alpha1ValidatingAdmissionPolicyListLens of TODO())
	}
}
