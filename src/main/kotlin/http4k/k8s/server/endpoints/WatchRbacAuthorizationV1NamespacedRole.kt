 ...
 * 		401 Unauthorized
 */
fun WatchRbacAuthorizationV1NamespacedRole(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/roles/{name}" bind Method.GET to { req: Request ->
