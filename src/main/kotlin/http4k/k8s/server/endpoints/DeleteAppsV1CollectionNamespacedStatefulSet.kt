 ...
 * 		401 Unauthorized
 */
fun DeleteAppsV1CollectionNamespacedStatefulSet(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/namespaces/{namespace}/statefulsets" bind Method.DELETE to { req: Request ->
