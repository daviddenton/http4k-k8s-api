 ...
 * 		401 Unauthorized
 */
fun WatchAutoscalingV1HorizontalPodAutoscalerListForAllNamespaces(): RoutingHttpHandler {
    ...
    return "/apis/autoscaling/v1/watch/horizontalpodautoscalers" bind Method.GET to { req: Request ->
