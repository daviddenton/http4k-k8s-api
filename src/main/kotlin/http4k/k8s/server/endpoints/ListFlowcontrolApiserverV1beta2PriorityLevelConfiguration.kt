 ...
 * 		401 Unauthorized
 */
fun ListFlowcontrolApiserverV1beta2PriorityLevelConfiguration(): RoutingHttpHandler {
	...
	return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapiflowcontrolv1beta2PriorityLevelConfigurationListLens of TODO())
	}
}
