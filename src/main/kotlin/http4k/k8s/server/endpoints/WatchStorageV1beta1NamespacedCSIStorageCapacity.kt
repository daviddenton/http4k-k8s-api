 ...
 * 		401 Unauthorized
 */
fun WatchStorageV1beta1NamespacedCSIStorageCapacity(): RoutingHttpHandler {
	...
	return "/apis/storage.k8s.io/v1beta1/watch/namespaces/{namespace}/csistoragecapacities/{name}" bind Method.GET to { req: Request ->
