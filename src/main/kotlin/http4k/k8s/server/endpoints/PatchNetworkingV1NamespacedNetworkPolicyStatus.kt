 ...
 * 		401 Unauthorized
 */
fun PatchNetworkingV1NamespacedNetworkPolicyStatus(): RoutingHttpHandler {
	...
	return "/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies/{name}/status" bind Method.PATCH to { req: Request ->
