 ...
 * 		401 Unauthorized
 */
fun PatchPolicyV1NamespacedPodDisruptionBudget(): RoutingHttpHandler {
    ...
    return "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}" bind Method.PATCH to { req: Request ->
