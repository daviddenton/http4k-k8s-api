 ...
 * 		401 Unauthorized
 */
fun ListCoreV1NamespacedEndpoints(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/endpoints" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapicorev1EndpointsListLens of TODO())
	}
}
