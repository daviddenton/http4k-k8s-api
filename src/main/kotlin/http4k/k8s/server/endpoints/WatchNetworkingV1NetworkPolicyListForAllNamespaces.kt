 ...
 * 		401 Unauthorized
 */
fun WatchNetworkingV1NetworkPolicyListForAllNamespaces(): RoutingHttpHandler {
	...
	return "/apis/networking.k8s.io/v1/watch/networkpolicies" bind Method.GET to { req: Request ->
