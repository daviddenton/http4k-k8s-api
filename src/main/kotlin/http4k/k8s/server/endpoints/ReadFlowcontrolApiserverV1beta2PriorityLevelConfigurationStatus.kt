 ...
 * 		401 Unauthorized
 */
fun ReadFlowcontrolApiserverV1beta2PriorityLevelConfigurationStatus(): RoutingHttpHandler {
    val iok8sapiflowcontrolv1beta2PriorityLevelConfigurationLens =
        Body.auto<PriorityLevelConfiguration>().toLens()
    val nameLens = Path.string().of("name")
    val prettyLens = Query.string().optional("pretty")

    return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations/{name}/status" bind Method.GET to { req: Request ->
