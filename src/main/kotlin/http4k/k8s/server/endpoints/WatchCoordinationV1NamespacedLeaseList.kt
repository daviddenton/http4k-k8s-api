 ...
 * 		401 Unauthorized
 */
fun WatchCoordinationV1NamespacedLeaseList(): RoutingHttpHandler {
	...
	return "/apis/coordination.k8s.io/v1/watch/namespaces/{namespace}/leases" bind Method.GET to { req: Request ->
