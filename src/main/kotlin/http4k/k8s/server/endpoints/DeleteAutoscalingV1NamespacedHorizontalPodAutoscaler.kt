 ...
 * 		401 Unauthorized
 */
fun DeleteAutoscalingV1NamespacedHorizontalPodAutoscaler(): RoutingHttpHandler {
    ...
    return "/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}" bind Method.DELETE to { req: Request ->
