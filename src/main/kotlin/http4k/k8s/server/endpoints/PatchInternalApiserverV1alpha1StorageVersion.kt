 ...
 * 		401 Unauthorized
 */
fun PatchInternalApiserverV1alpha1StorageVersion(): RoutingHttpHandler {
	...
	return "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}" bind Method.PATCH to { req: Request ->
