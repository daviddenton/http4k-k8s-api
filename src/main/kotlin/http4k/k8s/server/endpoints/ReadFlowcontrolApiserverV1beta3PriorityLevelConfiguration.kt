 ...
 * 		401 Unauthorized
 */
fun ReadFlowcontrolApiserverV1beta3PriorityLevelConfiguration(): RoutingHttpHandler {
    val iok8sapiflowcontrolv1beta3PriorityLevelConfigurationLens =
        Body.auto<PriorityLevelConfiguration>().toLens()
    val nameLens = Path.string().of("name")
    val prettyLens = Query.string().optional("pretty")

    return "/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/{name}" bind Method.GET to { req: Request ->
