 ...
 * 		401 Unauthorized
 */
fun DeleteCoordinationV1CollectionNamespacedLease(): RoutingHttpHandler {
	...
	return "/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases" bind Method.DELETE to { req: Request ->
