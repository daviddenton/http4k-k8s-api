 ...
 * 		401 Unauthorized
 */
fun ReplaceFlowcontrolApiserverV1beta2PriorityLevelConfiguration(): RoutingHttpHandler {
	...
	return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations/{name}" bind Method.PUT to { req: Request ->
