 ...
 * 		401 Unauthorized
 */
fun ListCoreV1NamespacedSecret(): RoutingHttpHandler {
    ...
    return "/api/v1/namespaces/{namespace}/secrets" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapicorev1SecretListLens of TODO())
    }
}
