 ...
 * 		401 Unauthorized
 */
fun WatchInternalApiserverV1alpha1StorageVersionList(): RoutingHttpHandler {
	...
	return "/apis/internal.apiserver.k8s.io/v1alpha1/watch/storageversions" bind Method.GET to { req: Request ->
