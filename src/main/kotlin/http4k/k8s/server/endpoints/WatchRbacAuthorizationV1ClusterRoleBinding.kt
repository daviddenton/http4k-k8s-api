 ...
 * 		401 Unauthorized
 */
fun WatchRbacAuthorizationV1ClusterRoleBinding(): RoutingHttpHandler {
	...
	return "/apis/rbac.authorization.k8s.io/v1/watch/clusterrolebindings/{name}" bind Method.GET to { req: Request ->
