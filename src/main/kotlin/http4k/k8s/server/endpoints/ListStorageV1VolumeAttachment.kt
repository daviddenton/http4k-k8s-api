 ...
 * 		401 Unauthorized
 */
fun ListStorageV1VolumeAttachment(): RoutingHttpHandler {
    ...
    return "/apis/storage.k8s.io/v1/volumeattachments" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapistoragev1VolumeAttachmentListLens of TODO())
    }
}
