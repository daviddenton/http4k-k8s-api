 ...
 * 		401 Unauthorized
 */
fun PatchAppsV1NamespacedStatefulSetScale(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/namespaces/{namespace}/statefulsets/{name}/scale" bind Method.PATCH to { req: Request ->
