 ...
 * 		401 Unauthorized
 */
fun DeleteApiextensionsV1CustomResourceDefinition(): RoutingHttpHandler {
    ...
    return "/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}" bind Method.DELETE to { req: Request ->
