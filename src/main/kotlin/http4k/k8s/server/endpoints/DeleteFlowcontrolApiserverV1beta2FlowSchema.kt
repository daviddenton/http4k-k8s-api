 ...
 * 		401 Unauthorized
 */
fun DeleteFlowcontrolApiserverV1beta2FlowSchema(): RoutingHttpHandler {
	...
	return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}" bind Method.DELETE to { req: Request ->
