 ...
 * 		401 Unauthorized
 */
fun PatchAdmissionregistrationV1ValidatingWebhookConfiguration(): RoutingHttpHandler {
	...
	return "/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}" bind Method.PATCH to { req: Request ->
