 ...
 * 		401 Unauthorized
 */
fun DeleteResourceV1alpha1NamespacedResourceClaimTemplate(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates/{name}" bind Method.DELETE to { req: Request ->
