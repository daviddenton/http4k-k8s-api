 ...
 * 		401 Unauthorized
 */
fun WatchDiscoveryV1NamespacedEndpointSliceList(): RoutingHttpHandler {
    ...
    return "/apis/discovery.k8s.io/v1/watch/namespaces/{namespace}/endpointslices" bind Method.GET to { req: Request ->
