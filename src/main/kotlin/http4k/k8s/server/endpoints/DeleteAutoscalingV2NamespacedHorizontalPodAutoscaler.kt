 ...
 * 		401 Unauthorized
 */
fun DeleteAutoscalingV2NamespacedHorizontalPodAutoscaler(): RoutingHttpHandler {
	...
	return "/apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers/{name}" bind Method.DELETE to { req: Request ->
