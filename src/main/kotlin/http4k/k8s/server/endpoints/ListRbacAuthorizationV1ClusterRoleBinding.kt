 ...
 * 		401 Unauthorized
 */
fun ListRbacAuthorizationV1ClusterRoleBinding(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/clusterrolebindings" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapirbacv1ClusterRoleBindingListLens of TODO())
    }
}
