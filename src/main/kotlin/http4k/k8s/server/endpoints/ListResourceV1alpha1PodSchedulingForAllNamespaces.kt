 ...
 * 		401 Unauthorized
 */
fun ListResourceV1alpha1PodSchedulingForAllNamespaces(): RoutingHttpHandler {
    ...
    return "/apis/resource.k8s.io/v1alpha1/podschedulings" bind Method.GET to { req: Request ->
