 ...
 * 		401 Unauthorized
 */
fun ReplaceNetworkingV1NamespacedNetworkPolicy(): RoutingHttpHandler {
	...
	return "/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies/{name}" bind Method.PUT to { req: Request ->
