 ...
 * 		401 Unauthorized
 */
fun ReplaceCoreV1NamespacedReplicationControllerScale(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/replicationcontrollers/{name}/scale" bind Method.PUT to { req: Request ->
