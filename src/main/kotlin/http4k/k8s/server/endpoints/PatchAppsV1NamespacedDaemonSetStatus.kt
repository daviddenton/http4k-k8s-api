 ...
 * 		401 Unauthorized
 */
fun PatchAppsV1NamespacedDaemonSetStatus(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}/status" bind Method.PATCH to { req: Request ->
