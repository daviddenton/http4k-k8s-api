 ...
 * 		401 Unauthorized
 */
fun ConnectCoreV1PostNamespacedPodExec(): RoutingHttpHandler {
    ...
    return "/api/v1/namespaces/{namespace}/pods/{name}/exec" bind Method.POST to { req: Request ->
        ...
        val tty = ttyLens(req)
        Response(Status.OK)
            .with(connectCoreV1PostNamespacedPodExecResponse200Lens of TODO())
    }
}
