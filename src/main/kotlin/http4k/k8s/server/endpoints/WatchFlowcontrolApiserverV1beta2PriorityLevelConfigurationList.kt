 ...
 * 		401 Unauthorized
 */
fun WatchFlowcontrolApiserverV1beta2PriorityLevelConfigurationList(): RoutingHttpHandler {
	...
	return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/watch/prioritylevelconfigurations" bind Method.GET to { req: Request ->
