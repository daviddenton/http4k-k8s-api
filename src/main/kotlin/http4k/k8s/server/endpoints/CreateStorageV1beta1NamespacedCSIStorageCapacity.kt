 ...
 * 		401 Unauthorized
 */
fun CreateStorageV1beta1NamespacedCSIStorageCapacity(): RoutingHttpHandler {
    ...
    return "/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities" bind Method.POST to { req: Request ->
