 ...
 * 		401 Unauthorized
 */
fun ReadResourceV1alpha1NamespacedResourceClaim(): RoutingHttpHandler {
	val iok8sapiresourcev1alpha1ResourceClaimLens = Body.auto<ResourceClaim>().toLens()
	val nameLens = Path.string().of("name")
	val namespaceLens = Path.string().of("namespace")
	val prettyLens = Query.string().optional("pretty")

	return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaims/{name}" bind Method.GET to { req: Request ->
