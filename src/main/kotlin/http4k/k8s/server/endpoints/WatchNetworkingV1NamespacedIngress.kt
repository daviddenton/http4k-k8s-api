 ...
 * 		401 Unauthorized
 */
fun WatchNetworkingV1NamespacedIngress(): RoutingHttpHandler {
    ...
    return "/apis/networking.k8s.io/v1/watch/namespaces/{namespace}/ingresses/{name}" bind Method.GET to { req: Request ->
