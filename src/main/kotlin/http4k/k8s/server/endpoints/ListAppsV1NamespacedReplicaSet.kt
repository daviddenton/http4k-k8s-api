 ...
 * 		401 Unauthorized
 */
fun ListAppsV1NamespacedReplicaSet(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/namespaces/{namespace}/replicasets" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapiappsv1ReplicaSetListLens of TODO())
    }
}
