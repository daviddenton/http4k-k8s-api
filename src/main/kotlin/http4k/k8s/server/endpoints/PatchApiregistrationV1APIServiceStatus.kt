 ...
 * 		401 Unauthorized
 */
fun PatchApiregistrationV1APIServiceStatus(): RoutingHttpHandler {
    ...
    return "/apis/apiregistration.k8s.io/v1/apiservices/{name}/status" bind Method.PATCH to { req: Request ->
