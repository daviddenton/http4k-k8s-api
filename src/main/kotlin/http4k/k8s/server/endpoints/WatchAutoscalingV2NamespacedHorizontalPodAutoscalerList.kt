 ...
 * 		401 Unauthorized
 */
fun WatchAutoscalingV2NamespacedHorizontalPodAutoscalerList(): RoutingHttpHandler {
    ...
    return "/apis/autoscaling/v2/watch/namespaces/{namespace}/horizontalpodautoscalers" bind Method.GET to { req: Request ->
