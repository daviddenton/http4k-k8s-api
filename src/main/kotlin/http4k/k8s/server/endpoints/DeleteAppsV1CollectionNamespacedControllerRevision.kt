 ...
 * 		401 Unauthorized
 */
fun DeleteAppsV1CollectionNamespacedControllerRevision(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/namespaces/{namespace}/controllerrevisions" bind Method.DELETE to { req: Request ->
