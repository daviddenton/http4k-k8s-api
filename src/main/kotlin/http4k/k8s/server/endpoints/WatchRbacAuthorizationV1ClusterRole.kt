 ...
 * 		401 Unauthorized
 */
fun WatchRbacAuthorizationV1ClusterRole(): RoutingHttpHandler {
    ...
    return "/apis/rbac.authorization.k8s.io/v1/watch/clusterroles/{name}" bind Method.GET to { req: Request ->
