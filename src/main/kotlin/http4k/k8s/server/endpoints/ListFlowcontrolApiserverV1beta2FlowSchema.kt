 ...
 * 		401 Unauthorized
 */
fun ListFlowcontrolApiserverV1beta2FlowSchema(): RoutingHttpHandler {
	...
	return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapiflowcontrolv1beta2FlowSchemaListLens of TODO())
	}
}
