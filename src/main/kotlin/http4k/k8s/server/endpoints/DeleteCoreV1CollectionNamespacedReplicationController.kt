 ...
 * 		401 Unauthorized
 */
fun DeleteCoreV1CollectionNamespacedReplicationController(): RoutingHttpHandler {
    ...
    return "/api/v1/namespaces/{namespace}/replicationcontrollers" bind Method.DELETE to { req: Request ->
