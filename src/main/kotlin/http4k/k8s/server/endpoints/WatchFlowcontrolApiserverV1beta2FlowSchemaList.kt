 ...
 * 		401 Unauthorized
 */
fun WatchFlowcontrolApiserverV1beta2FlowSchemaList(): RoutingHttpHandler {
	...
	return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/watch/flowschemas" bind Method.GET to { req: Request ->
