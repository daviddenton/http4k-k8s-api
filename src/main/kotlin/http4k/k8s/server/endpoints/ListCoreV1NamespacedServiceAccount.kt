 ...
 * 		401 Unauthorized
 */
fun ListCoreV1NamespacedServiceAccount(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/serviceaccounts" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapicorev1ServiceAccountListLens of TODO())
	}
}
