 ...
 * 		401 Unauthorized
 */
fun WatchAppsV1NamespacedControllerRevision(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/watch/namespaces/{namespace}/controllerrevisions/{name}" bind Method.GET to { req: Request ->
