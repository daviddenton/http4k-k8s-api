 ...
 * 		401 Unauthorized
 */
fun ListCoreV1PersistentVolume(): RoutingHttpHandler {
	...
	return "/api/v1/persistentvolumes" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapicorev1PersistentVolumeListLens of TODO())
	}
}
