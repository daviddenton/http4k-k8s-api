 ...
 * 		401 Unauthorized
 */
fun ConnectCoreV1HeadNodeProxyWithPath(): RoutingHttpHandler {
	...
	return "/api/v1/nodes/{name}/proxy/{path}" bind Method.HEAD to { req: Request ->
		val name = nameLens(req)
		val path = pathLens(req)
		val pathQuery = pathQueryLens(req)
		Response(Status.OK)
			.with(connectCoreV1HeadNodeProxyWithPathResponse200Lens of TODO())
	}
}
