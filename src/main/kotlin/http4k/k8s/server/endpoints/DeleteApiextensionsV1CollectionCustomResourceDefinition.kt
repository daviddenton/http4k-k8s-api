 ...
 * 		401 Unauthorized
 */
fun DeleteApiextensionsV1CollectionCustomResourceDefinition(): RoutingHttpHandler {
	...
	return "/apis/apiextensions.k8s.io/v1/customresourcedefinitions" bind Method.DELETE to { req: Request ->
