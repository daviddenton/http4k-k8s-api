 ...
 * 		401 Unauthorized
 */
fun ListSchedulingV1PriorityClass(): RoutingHttpHandler {
    ...
    return "/apis/scheduling.k8s.io/v1/priorityclasses" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapischedulingv1PriorityClassListLens of TODO())
    }
}
