 ...
 * 		401 Unauthorized
 */
fun WatchResourceV1alpha1ResourceClaimTemplateListForAllNamespaces(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/watch/resourceclaimtemplates" bind Method.GET to { req: Request ->
