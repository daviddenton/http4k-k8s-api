 ...
 * 		401 Unauthorized
 */
fun ListCoreV1NamespacedPod(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/pods" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapicorev1PodListLens of TODO())
	}
}
