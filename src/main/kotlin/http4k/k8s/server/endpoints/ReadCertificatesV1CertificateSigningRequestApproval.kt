 ...
 * 		401 Unauthorized
 */
fun ReadCertificatesV1CertificateSigningRequestApproval(): RoutingHttpHandler {
    val iok8sapicertificatesv1CertificateSigningRequestLens =
        Body.auto<CertificateSigningRequest>().toLens()
    val nameLens = Path.string().of("name")
    val prettyLens = Query.string().optional("pretty")

    return "/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}/approval" bind Method.GET to { req: Request ->
