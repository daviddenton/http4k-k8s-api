 ...
 * 		401 Unauthorized
 */
fun ReplaceFlowcontrolApiserverV1beta2FlowSchema(): RoutingHttpHandler {
	...
	return "/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}" bind Method.PUT to { req: Request ->
