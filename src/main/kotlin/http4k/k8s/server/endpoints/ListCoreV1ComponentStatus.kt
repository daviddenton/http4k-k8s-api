 ...
 * 		401 Unauthorized
 */
fun ListCoreV1ComponentStatus(): RoutingHttpHandler {
    ...
    return "/api/v1/componentstatuses" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapicorev1ComponentStatusListLens of TODO())
    }
}
