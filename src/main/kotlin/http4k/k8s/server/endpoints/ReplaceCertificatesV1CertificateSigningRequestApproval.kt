 ...
 * 		401 Unauthorized
 */
fun ReplaceCertificatesV1CertificateSigningRequestApproval(): RoutingHttpHandler {
	...
	return "/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}/approval" bind Method.PUT to { req: Request ->
