 ...
 * 		401 Unauthorized
 */
fun ListPolicyV1NamespacedPodDisruptionBudget(): RoutingHttpHandler {
    ...
    return "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapipolicyv1PodDisruptionBudgetListLens of TODO())
    }
}
