 ...
 * 		401 Unauthorized
 */
fun WatchCoreV1NamespacedReplicationController(): RoutingHttpHandler {
    ...
    return "/api/v1/watch/namespaces/{namespace}/replicationcontrollers/{name}" bind Method.GET to { req: Request ->
