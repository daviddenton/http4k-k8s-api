 ...
 * 		401 Unauthorized
 */
fun WatchResourceV1alpha1NamespacedPodScheduling(): RoutingHttpHandler {
    ...
    return "/apis/resource.k8s.io/v1alpha1/watch/namespaces/{namespace}/podschedulings/{name}" bind Method.GET to { req: Request ->
