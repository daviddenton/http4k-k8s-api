 ...
 * 		401 Unauthorized
 */
fun WatchDiscoveryV1EndpointSliceListForAllNamespaces(): RoutingHttpHandler {
    ...
    return "/apis/discovery.k8s.io/v1/watch/endpointslices" bind Method.GET to { req: Request ->
