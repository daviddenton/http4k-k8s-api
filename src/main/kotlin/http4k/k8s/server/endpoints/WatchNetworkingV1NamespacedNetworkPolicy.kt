 ...
 * 		401 Unauthorized
 */
fun WatchNetworkingV1NamespacedNetworkPolicy(): RoutingHttpHandler {
    ...
    return "/apis/networking.k8s.io/v1/watch/namespaces/{namespace}/networkpolicies/{name}" bind Method.GET to { req: Request ->
