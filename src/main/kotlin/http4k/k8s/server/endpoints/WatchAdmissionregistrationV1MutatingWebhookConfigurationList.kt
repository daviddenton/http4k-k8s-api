 ...
 * 		401 Unauthorized
 */
fun WatchAdmissionregistrationV1MutatingWebhookConfigurationList(): RoutingHttpHandler {
    ...
    return "/apis/admissionregistration.k8s.io/v1/watch/mutatingwebhookconfigurations" bind Method.GET to { req: Request ->
