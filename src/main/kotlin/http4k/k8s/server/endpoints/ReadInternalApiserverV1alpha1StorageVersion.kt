 ...
 * 		401 Unauthorized
 */
fun ReadInternalApiserverV1alpha1StorageVersion(): RoutingHttpHandler {
    val iok8sapiapiserverinternalv1alpha1StorageVersionLens = Body.auto<StorageVersion>().toLens()
    val nameLens = Path.string().of("name")
    val prettyLens = Query.string().optional("pretty")

    return "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}" bind Method.GET to { req: Request ->
