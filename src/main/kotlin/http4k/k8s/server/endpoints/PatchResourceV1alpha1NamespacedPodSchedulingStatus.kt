 ...
 * 		401 Unauthorized
 */
fun PatchResourceV1alpha1NamespacedPodSchedulingStatus(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings/{name}/status" bind Method.PATCH to { req: Request ->
