 ...
 * 		401 Unauthorized
 */
fun WatchNetworkingV1alpha1ClusterCIDR(): RoutingHttpHandler {
    ...
    return "/apis/networking.k8s.io/v1alpha1/watch/clustercidrs/{name}" bind Method.GET to { req: Request ->
