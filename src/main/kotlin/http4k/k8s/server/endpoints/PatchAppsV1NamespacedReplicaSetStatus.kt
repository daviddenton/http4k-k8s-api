 ...
 * 		401 Unauthorized
 */
fun PatchAppsV1NamespacedReplicaSetStatus(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/namespaces/{namespace}/replicasets/{name}/status" bind Method.PATCH to { req: Request ->
