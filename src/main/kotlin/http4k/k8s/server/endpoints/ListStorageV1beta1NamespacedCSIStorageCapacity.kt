...
import http4k.k8s.model.io.k8s.api.storage.v1beta1.CSIStorageCapacityList
 ...
 * 		401 Unauthorized
 */
fun ListStorageV1beta1NamespacedCSIStorageCapacity(): RoutingHttpHandler {
	val iok8sapistoragev1beta1CSIStorageCapacityListLens = Body.auto<CSIStorageCapacityList>().toLens()
	...
	return "/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapistoragev1beta1CSIStorageCapacityListLens of TODO())
	}
}
