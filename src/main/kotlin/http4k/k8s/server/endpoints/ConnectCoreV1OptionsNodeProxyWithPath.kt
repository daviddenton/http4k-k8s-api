 ...
 * 		401 Unauthorized
 */
fun ConnectCoreV1OptionsNodeProxyWithPath(): RoutingHttpHandler {
	...
	return "/api/v1/nodes/{name}/proxy/{path}" bind Method.OPTIONS to { req: Request ->
		val name = nameLens(req)
		val path = pathLens(req)
		val pathQuery = pathQueryLens(req)
		Response(Status.OK)
			.with(connectCoreV1OptionsNodeProxyWithPathResponse200Lens of TODO())
	}
}
