 ...
 * 		401 Unauthorized
 */
fun ReplaceAppsV1NamespacedDaemonSetStatus(): RoutingHttpHandler {
    ...
    return "/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}/status" bind Method.PUT to { req: Request ->
