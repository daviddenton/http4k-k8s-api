 ...
 * 		401 Unauthorized
 */
fun PatchNetworkingV1NamespacedNetworkPolicy(): RoutingHttpHandler {
    ...
    return "/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies/{name}" bind Method.PATCH to { req: Request ->
