 ...
 * 		401 Unauthorized
 */
fun ReplacePolicyV1NamespacedPodDisruptionBudget(): RoutingHttpHandler {
	...
	return "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}" bind Method.PUT to { req: Request ->
