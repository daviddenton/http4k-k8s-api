 ...
 * 		401 Unauthorized
 */
fun PatchCoreV1NamespacedResourceQuotaStatus(): RoutingHttpHandler {
    ...
    return "/api/v1/namespaces/{namespace}/resourcequotas/{name}/status" bind Method.PATCH to { req: Request ->
