 ...
 * 		401 Unauthorized
 */
fun ListResourceV1alpha1ResourceClass(): RoutingHttpHandler {
    ...
    return "/apis/resource.k8s.io/v1alpha1/resourceclasses" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapiresourcev1alpha1ResourceClassListLens of TODO())
    }
}
