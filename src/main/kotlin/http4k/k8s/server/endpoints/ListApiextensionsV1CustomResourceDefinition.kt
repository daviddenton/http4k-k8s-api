 ...
 * 		401 Unauthorized
 */
fun ListApiextensionsV1CustomResourceDefinition(): RoutingHttpHandler {
    ...
    return "/apis/apiextensions.k8s.io/v1/customresourcedefinitions" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapiextensionsapiserverpkgapisapiextensionsv1CustomResourceDefinitionListLens of TODO())
    }
}
