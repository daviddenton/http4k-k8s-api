 ...
 * 		401 Unauthorized
 */
fun DeleteCoreV1CollectionNamespacedServiceAccount(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/serviceaccounts" bind Method.DELETE to { req: Request ->
