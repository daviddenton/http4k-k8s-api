 ...
 * 		401 Unauthorized
 */
fun ListRbacAuthorizationV1NamespacedRoleBinding(): RoutingHttpHandler {
	...
	return "/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings" bind Method.GET to { req: Request ->
		...
		Response(Status.OK)
			.with(iok8sapirbacv1RoleBindingListLens of TODO())
	}
}
