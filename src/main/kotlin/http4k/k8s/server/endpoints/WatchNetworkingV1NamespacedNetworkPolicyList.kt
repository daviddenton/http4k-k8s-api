 ...
 * 		401 Unauthorized
 */
fun WatchNetworkingV1NamespacedNetworkPolicyList(): RoutingHttpHandler {
	...
	return "/apis/networking.k8s.io/v1/watch/namespaces/{namespace}/networkpolicies" bind Method.GET to { req: Request ->
