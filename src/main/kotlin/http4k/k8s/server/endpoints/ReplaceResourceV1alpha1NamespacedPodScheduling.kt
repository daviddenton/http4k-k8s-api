 ...
 * 		401 Unauthorized
 */
fun ReplaceResourceV1alpha1NamespacedPodScheduling(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/podschedulings/{name}" bind Method.PUT to { req: Request ->
