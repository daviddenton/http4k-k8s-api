...
import http4k.k8s.model.io.k8s.api.events.v1.EventList
 ...
 * 		401 Unauthorized
 */
fun ListEventsV1NamespacedEvent(): RoutingHttpHandler {
    val iok8sapieventsv1EventListLens = Body.auto<EventList>().toLens()
    ...
    return "/apis/events.k8s.io/v1/namespaces/{namespace}/events" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapieventsv1EventListLens of TODO())
    }
}
