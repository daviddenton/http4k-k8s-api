 ...
 * 		401 Unauthorized
 */
fun CreateCoreV1NamespacedPersistentVolumeClaim(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/persistentvolumeclaims" bind Method.POST to { req: Request ->
