 ...
 * 		401 Unauthorized
 */
fun DeleteResourceV1alpha1CollectionNamespacedResourceClaimTemplate(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/namespaces/{namespace}/resourceclaimtemplates" bind Method.DELETE to { req: Request ->
