 ...
 * 		401 Unauthorized
 */
fun ListCoreV1NamespacedEvent(): RoutingHttpHandler {
    ...
    return "/api/v1/namespaces/{namespace}/events" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapicorev1EventListLens of TODO())
    }
}
