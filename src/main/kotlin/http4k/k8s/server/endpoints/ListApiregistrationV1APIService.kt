 ...
 * 		401 Unauthorized
 */
fun ListApiregistrationV1APIService(): RoutingHttpHandler {
    ...
    return "/apis/apiregistration.k8s.io/v1/apiservices" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8skubeaggregatorpkgapisapiregistrationv1APIServiceListLens of TODO())
    }
}
