 ...
 * 		401 Unauthorized
 */
fun DeleteRbacAuthorizationV1NamespacedRole(): RoutingHttpHandler {
	...
	return "/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles/{name}" bind Method.DELETE to { req: Request ->
