 ...
 * 		401 Unauthorized
 */
fun DeleteAdmissionregistrationV1alpha1ValidatingAdmissionPolicy(): RoutingHttpHandler {
    ...
    return "/apis/admissionregistration.k8s.io/v1alpha1/validatingadmissionpolicies/{name}" bind Method.DELETE to { req: Request ->
