 ...
 * 		401 Unauthorized
 */
fun DeleteCertificatesV1CertificateSigningRequest(): RoutingHttpHandler {
    ...
    return "/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}" bind Method.DELETE to { req: Request ->
