 ...
 * 		401 Unauthorized
 */
fun DeleteAdmissionregistrationV1ValidatingWebhookConfiguration(): RoutingHttpHandler {
	...
	return "/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}" bind Method.DELETE to { req: Request ->
