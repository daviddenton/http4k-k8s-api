 ...
 * 		401 Unauthorized
 */
fun DeleteAppsV1CollectionNamespacedDeployment(): RoutingHttpHandler {
	...
	return "/apis/apps/v1/namespaces/{namespace}/deployments" bind Method.DELETE to { req: Request ->
