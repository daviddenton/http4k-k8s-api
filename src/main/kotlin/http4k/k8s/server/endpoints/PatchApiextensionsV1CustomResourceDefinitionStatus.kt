 ...
 * 		401 Unauthorized
 */
fun PatchApiextensionsV1CustomResourceDefinitionStatus(): RoutingHttpHandler {
    ...
    return "/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}/status" bind Method.PATCH to { req: Request ->
