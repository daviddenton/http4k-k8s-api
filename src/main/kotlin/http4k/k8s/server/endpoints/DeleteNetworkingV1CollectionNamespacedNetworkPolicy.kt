 ...
 * 		401 Unauthorized
 */
fun DeleteNetworkingV1CollectionNamespacedNetworkPolicy(): RoutingHttpHandler {
	...
	return "/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies" bind Method.DELETE to { req: Request ->
