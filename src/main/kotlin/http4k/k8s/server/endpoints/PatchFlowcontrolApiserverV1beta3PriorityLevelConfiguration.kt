 ...
 * 		401 Unauthorized
 */
fun PatchFlowcontrolApiserverV1beta3PriorityLevelConfiguration(): RoutingHttpHandler {
    ...
    return "/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations/{name}" bind Method.PATCH to { req: Request ->
