 ...
 * 		401 Unauthorized
 */
fun WatchApiextensionsV1CustomResourceDefinitionList(): RoutingHttpHandler {
    ...
    return "/apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions" bind Method.GET to { req: Request ->
