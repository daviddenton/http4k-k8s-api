 ...
 * 		401 Unauthorized
 */
fun DeleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscaler(): RoutingHttpHandler {
	...
	return "/apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers" bind Method.DELETE to { req: Request ->
