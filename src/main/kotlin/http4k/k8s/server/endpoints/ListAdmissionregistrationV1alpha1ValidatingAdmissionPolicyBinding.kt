 ...
 * 		401 Unauthorized
 */
fun ListAdmissionregistrationV1alpha1ValidatingAdmissionPolicyBinding(): RoutingHttpHandler {
    ...
    return "/apis/admissionregistration.k8s.io/v1alpha1/validatingadmissionpolicybindings" bind Method.GET to { req: Request ->
        ...
        Response(Status.OK)
            .with(iok8sapiadmissionregistrationv1alpha1ValidatingAdmissionPolicyBindingListLens of TODO())
    }
}
