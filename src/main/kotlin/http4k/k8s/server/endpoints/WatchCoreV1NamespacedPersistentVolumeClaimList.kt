 ...
 * 		401 Unauthorized
 */
fun WatchCoreV1NamespacedPersistentVolumeClaimList(): RoutingHttpHandler {
	...
	return "/api/v1/watch/namespaces/{namespace}/persistentvolumeclaims" bind Method.GET to { req: Request ->
