 ...
 * 		401 Unauthorized
 */
fun PatchCoreV1NamespacedPodEphemeralcontainers(): RoutingHttpHandler {
    ...
    return "/api/v1/namespaces/{namespace}/pods/{name}/ephemeralcontainers" bind Method.PATCH to { req: Request ->
