 ...
 * 		401 Unauthorized
 */
fun CreateCoreV1NamespacedReplicationController(): RoutingHttpHandler {
    ...
    return "/api/v1/namespaces/{namespace}/replicationcontrollers" bind Method.POST to { req: Request ->
