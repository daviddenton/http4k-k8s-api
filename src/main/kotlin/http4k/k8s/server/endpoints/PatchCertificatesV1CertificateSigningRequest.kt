 ...
 * 		401 Unauthorized
 */
fun PatchCertificatesV1CertificateSigningRequest(): RoutingHttpHandler {
	...
	return "/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}" bind Method.PATCH to { req: Request ->
