 ...
 * 		401 Unauthorized
 */
fun DeleteCoreV1NamespacedPersistentVolumeClaim(): RoutingHttpHandler {
	...
	return "/api/v1/namespaces/{namespace}/persistentvolumeclaims/{name}" bind Method.DELETE to { req: Request ->
