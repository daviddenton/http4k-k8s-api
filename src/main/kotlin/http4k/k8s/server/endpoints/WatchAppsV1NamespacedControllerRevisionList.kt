 ...
 * 		401 Unauthorized
 */
fun WatchAppsV1NamespacedControllerRevisionList(): RoutingHttpHandler {
	...
	return "/apis/apps/v1/watch/namespaces/{namespace}/controllerrevisions" bind Method.GET to { req: Request ->
