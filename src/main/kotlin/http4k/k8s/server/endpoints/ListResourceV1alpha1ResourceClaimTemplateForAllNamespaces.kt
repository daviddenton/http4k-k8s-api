 ...
 * 		401 Unauthorized
 */
fun ListResourceV1alpha1ResourceClaimTemplateForAllNamespaces(): RoutingHttpHandler {
	...
	return "/apis/resource.k8s.io/v1alpha1/resourceclaimtemplates" bind Method.GET to { req: Request ->
